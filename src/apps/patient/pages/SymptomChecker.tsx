...
const symptomCheckerCopy = {
  en: {
    ...
    possibleConditionsHint: "Each condition includes a concise medical definition, likely causes, supporting symptoms, and typical treatment context. Overall severity is separate from individual condition likelihood.",
