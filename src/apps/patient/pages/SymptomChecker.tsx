...
interface TriageResult {
  ...
  summary: string;
  possible_conditions: { name: string; likelihood: "high" | "medium" | "low"; reason: string }[];
...
const symptomCheckerCopy = {
  en: {
    ...
    possibleConditionsHint: "Conditions marked \"Likely\" are the strongest matches based on your reported symptoms, while \"Possible\" and \"Less likely\" remain alternative explanations.",
...
function buildSymptomReport(params: {
  ...
  const possibleConditions = result.possible_conditions.length > 0
    ? result.possible_conditions.map((c) => `- ${c.name} (${c.likelihood})\n  Reason: ${c.reason}`).join("\n")
    : "- None listed";
